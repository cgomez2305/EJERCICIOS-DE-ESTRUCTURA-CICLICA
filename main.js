...
let niños=0;niñosPeso=0;jovenes=0;jovenesPeso=0;adultos=0;adultosPeso=0;viejos=0;viejosPeso=0;edad=0;peso=0;totalNiños=0;totalViejos=0;totalAdultos=0;totalViejos=0;totalJovenes=0;totalJovenes=0;
...
totalAdultos=adultosPeso/adultos
totalJovenes=jovenesPeso/jovenes
totalNiños=niñosPeso/niños
totalViejos=viejosPeso/viejos
...
console.log(`el promedio de peso en niños:${totalNiños} jovenes:${totalJovenes} adultos:${totalAdultos} viejos:${totalViejos}`)
...
//     suma2+=nota2
// } 
// console.log(`el promedio final de ${nombre} es : ${((suma1/2)*0.4)+((suma2/3)*0.6)}`)
